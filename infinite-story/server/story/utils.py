...
def make_default_title_from_origin(origin):
    if origin.get("name", False):
        return origin["name"] + ", the " + origin["class"]
    else:
        return origin["class"] + " from " + origin["location"]
...
def cut_trailing_sentence(text):
    # TODO: debug this it loops
    # Why is this wrong?
    '"I\'m fine," you say. "Who are you?"\n> You .\n"My name is Tanya."\n> You .\n"Are you a ghost? I\'ve never seen anything like you before."\n> You .\n"No, I\'m not a ghost. I'
